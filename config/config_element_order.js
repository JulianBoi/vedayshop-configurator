let config_order_element = new Map();
    // ADD 4 PIN EPS
    let cable4pinEPS = new Map();
    config_order_element.set('CABLE_4_PIN_EPS',cable4pinEPS);
        // CONFIG 4 PIN EPS
        cable4pinEPS.set('PRICE',1);
